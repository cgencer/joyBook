...
// PIOSpriteKit
#define COCOAPODS_POD_AVAILABLE_PIOSpriteKit
#define COCOAPODS_VERSION_MAJOR_PIOSpriteKit 0
#define COCOAPODS_VERSION_MINOR_PIOSpriteKit 1
#define COCOAPODS_VERSION_PATCH_PIOSpriteKit 0

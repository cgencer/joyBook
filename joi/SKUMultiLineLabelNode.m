...
-(void) retexture
{
	...
	selfNode.anchorPoint = _myAnchor;
}

- (void)setMyAnchor:(CGPoint)myAnchor
{
    _myAnchor = myAnchor;
}
...
//	NSLog(@"textRect = %f %f %f %f", textRect.origin.x, textRect.origin.y, textRect.size.width, textRect.size.height);
    ...
    CGContextSetShouldSmoothFonts(currentContext, false);
    CGContextSetAllowsFontSmoothing(currentContext, false);
    CGContextSetAllowsAntialiasing(currentContext, false);
